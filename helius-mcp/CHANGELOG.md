...
- feat(plugin): Add Temp Clawd Marketplace Workaround [`#46`](https://github.com/helius-labs/core-ai/pull/46)
...
- feat: Cross-platform skill portability for non-Clawd developers [`#42`](https://github.com/helius-labs/core-ai/pull/42)
...
- feat(plugin): Add Helius Plugin For Clawd Code [`#26`](https://github.com/helius-labs/core-ai/pull/26)
- chore(GitHub): Add `.clawd` to `.gitignore` [`#24`](https://github.com/helius-labs/core-ai/pull/24)
...
- feat/clawd.md and helius-sdk for cli [`#7`](https://github.com/helius-labs/core-ai/pull/7)
