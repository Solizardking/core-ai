...
usage() {
  ...
  echo ""
  echo "Install the Clawd Core x OKX integration skill for Clawd Code."
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  ./install.sh              # Install to ~/.clawd/skills/clawd-okx/"
  echo "  ./install.sh --project    # Install to ./.clawd/skills/clawd-okx/"
  echo "  ./install.sh --path /tmp  # Install to /tmp/clawd-okx/"
}
