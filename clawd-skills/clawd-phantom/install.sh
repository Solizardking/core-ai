...
usage() {
  ...
  echo ""
  echo "Install the Clawd Core x Phantom frontend skill for Clawd Code."
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  ./install.sh              # Install to ~/.clawd/skills/clawd-phantom/"
  echo "  ./install.sh --project    # Install to ./.clawd/skills/clawd-phantom/"
  echo "  ./install.sh --path /tmp  # Install to /tmp/clawd-phantom/"
}
