...
Thank you for your interest in contributing to Membrain!
...
When modifying the protobuf definition (`api/proto/membrain/v1/membrain.proto`):
...
8. Update the Python client in `clients/python/membrain/client.py`
9. Update Python types in `clients/python/membrain/types.py` if new enums/types are added
10. Update `clients/python/membrain/__init__.py` exports
...
- The token must have publish permissions for the `@membrain` npm scope
