/**
 * @vainplex/openclawd-membrane — Membrane bridge plugin for OpenClawd
 *
 * Provides:
...
/**
 * OpenClawd plugin bridge to Membrane episodic memory.
...
export class OpenClawMembranePlugin {
  ...
  async handleEvent(event: OpenClawEvent): Promise<void> {
    ...
    const source = event.agentId ?? "openclawd";
