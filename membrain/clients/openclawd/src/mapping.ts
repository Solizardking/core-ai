/**
 * Maps OpenClawd events to Membrane ingestion formats.
 */

import type { OpenClawEvent } from "./types.js";

/** Map OpenClawd sensitivity strings to Membrane sensitivity levels */
...
/** Determine the best Membrane ingestion method for an OpenClawd event */
...
/** Extract a human-readable summary from an OpenClawd event */
...
/** Build tags from an OpenClawd event */
