...
Welcome to the Clawd MCP Server! Thank you for considering to contribute; we value your input and want to make it as easy as possible for you to help. Here's how you can help make the MCP server better. Before starting, please read this guide carefully to ensure your contributions align with our standards.
...
1. A maintainer tags a release: `git tag clawd-mcp@X.Y.Z && git push origin clawd-mcp@X.Y.Z`
...
By contributing, you agree that your contributions will be licensed under its MIT License. Thus, when you submit code changes, your submissions are understood to be under the [following license](https://github.com/Solizardking/core-ai/blob/main/clawd-mcp/LICENSE).

## Thank You!

We deeply appreciate your effort in making the Clawd MCP Server better. Your contributions help power better tools for everyone in the Solana ecosystem!
