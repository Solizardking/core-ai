...
function makeEntry(
  ...
  return {
    ...
    mutability: overrides.mutability ?? (publicTool === 'clawdWrite' ? 'write' : 'read'),
    responseFamily,
    defaultDetail,
...
addEntries(catalog, CLAWD_COMPRESSION_ACTIONS, {
