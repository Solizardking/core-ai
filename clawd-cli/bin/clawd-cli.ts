...
program
  .name("clawd-cli")
  .description("Clawd CLI — manage accounts, query Solana data, and interact with the Helius platform")
  .version(VERSION)
  ...
  .hook('postAction', (_thisCommand, actionCommand) => {
    ...
    if (!actionCommand.opts().json && cmd !== 'feedback') {
      console.log('\n' + chalk.yellow(`Please run: clawd-cli feedback "<your feedback on ${cmd}>" --feedback-tool ${cmd} --model <your-model>`));
    }
  });
...
Examples:
  $ clawd-cli keygen
  $ clawd-cli keygen --output ~/my-keypair.json
  $ clawd-cli keygen --force --json`)
...
Examples:
  $ clawd-cli signup --email you@example.com --first-name Jane --last-name Doe
      ...
      Open the URL in a browser, pay USDC, then run \`clawd-cli signup --resume\`
  ...
  $ clawd-cli signup --restart --plan developer --period yearly ...
...
program
  ...
  .addHelpText("after", `
Examples:
  $ clawd-cli upgrade --plan business --period yearly
      Print the upgrade payment URL and exit. Open it in a browser, pay USDC,
      then run \`clawd-cli upgrade --resume\` to confirm locally.

  $ clawd-cli upgrade --plan developer --pay
      Auto-pay from the local keypair, poll activation, surface SUCCESS / PENDING.

  $ clawd-cli upgrade --resume
...
Examples:
  $ clawd-cli login
  $ clawd-cli login --no-browser
  $ clawd-cli login --json

Wallet-based account creation continues to work via \`clawd-cli signup\`.`)
  .action(loginCommand);
...
Examples:
  $ clawd-cli logout
  $ clawd-cli logout --all
  $ clawd-cli logout --json`)
...
Examples:
  $ clawd-cli whoami
  $ clawd-cli whoami --verify
  $ clawd-cli whoami --json`)
...
Examples:
  $ clawd-cli project
  $ clawd-cli project proj_abc123 --json`)
...
apikeysCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli apikeys create
  $ clawd-cli apikeys create proj_abc123 --json`)
...
Examples:
  $ clawd-cli usage
  $ clawd-cli usage proj_abc123 --json`)
  .action(usageCommand);
...
Examples:
  $ clawd-cli rpc
  $ clawd-cli rpc proj_abc123 --json`)
  .action(rpcCommand);
...
configCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli config show
  $ clawd-cli config show --reveal --json`)
...
configCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli config set-api-key your-api-key-here`)
...
configCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli config set-network devnet
  $ clawd-cli config set-network mainnet`)
...
configCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli config set-project proj_abc123`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli balance 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli balance 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json
  $ clawd-cli balance 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --network devnet`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli tokens 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli tokens 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 50 --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli token-holders EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v
  $ clawd-cli token-holders EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --limit 10 --json`)
...
txCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli tx parse 5UfDuX7hXbDjdMRbQMCbNvPZQEr4mEAMq3fNM7oKnUFqpEygPoAEsm2MFVwfCaG1CjprB2og8LmNVBLMrACG7L4
  $ clawd-cli tx parse sig1 sig2 sig3 --json`)
...
txCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli tx history 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli tx history 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 5 --type SWAP --json`)
...
txCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli tx transfers 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 5
  $ clawd-cli tx transfers <addr> --mint EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --direction in
  $ clawd-cli tx transfers <addr> --with <counterparty> --block-time-gte 1700000000 --json`)
...
Examples:
  $ clawd-cli tx fees
  $ clawd-cli tx fees --accounts JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4 --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset get EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v
  $ clawd-cli asset get EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset batch EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v So11111111111111111111111111111111111111112 --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli asset owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 50 --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset creator J1S9H3QjnRtBbbuD4HjPV6RpRhwuk4zKbxsnCHuTgh9w --verified --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset authority 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset collection J1S9H3QjnRtBbbuD4HjPV6RpRhwuk4zKbxsnCHuTgh9w --limit 20 --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset search --owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --compressed
  $ clawd-cli asset search --creator J1S9H3QjnRtBbbuD4HjPV6RpRhwuk4zKbxsnCHuTgh9w --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset proof <compressed-nft-mint> --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset proof-batch <mint1> <mint2> --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset editions <master-nft-mint> --limit 10 --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset signatures EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
assetCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli asset token-accounts --owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli asset token-accounts --mint EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli account 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli account TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli network-status
  $ clawd-cli network-status --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli block 250000000
  $ clawd-cli block 250000000 --json`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet identity 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli wallet identity toly.sol
  $ clawd-cli wallet identity helius.bonk`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet identity-batch 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --json
  $ clawd-cli wallet identity-batch toly.sol 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet balances 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli wallet balances 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --show-nfts --json`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet history 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 10
  $ clawd-cli wallet history 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --type SWAP --json`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet transfers 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --limit 20 --json`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet funded-by 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
walletCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli wallet ows-link my-wallet`)
...
webhookCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli webhook list
  $ clawd-cli webhook list --json`)
...
webhookCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli webhook get wh_abc123 --json`)
...
webhookCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli webhook create --url https://example.com/hook --accounts 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --types ANY
  $ clawd-cli webhook create --url https://example.com/hook --accounts addr1,addr2 --types SWAP,TRANSFER --json`)
...
webhookCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli webhook update wh_abc123 --url https://example.com/new-hook
  $ clawd-cli webhook update wh_abc123 --accounts addr1,addr2 --json`)
...
webhookCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli webhook delete wh_abc123`)
...
programCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli program accounts TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --limit 10
  $ clawd-cli program accounts TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --data-size 165 --json`)
...
programCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli program accounts-all TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --json`)
...
programCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli program token-accounts 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
stakeCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli stake accounts 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
stakeCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli stake withdrawable <stake-account> --json`)
...
stakeCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli stake instructions 5
  $ clawd-cli stake instructions --amount 5
  $ clawd-cli stake instructions --raw-amount 5000000000 --json`)
...
stakeCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli stake unstake-instruction <stake-account> --json`)
...
stakeCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli stake withdraw-instruction <stake-account> --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk account 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk accounts-by-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk balance 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk balance-by-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk token-holders EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk token-balance 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk token-accounts-by-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk token-accounts-by-delegate 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk token-balances-by-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk proof 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk proofs 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk multiple-accounts 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk address-proofs 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk signatures-account 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk signatures-address 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk signatures-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk signatures-token-owner 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk latest-signatures --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk latest-non-voting --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk tx 5UfDuX7hXbDjdMRbQMCbNvPZQEr4mEAMq3fNM7oKnUFqpEygPoAEsm2MFVwfCaG1CjprB2og8LmNVBLMrACG7L4 --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk validity-proof --addresses 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk indexer-health --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk indexer-slot --json`)
...
zkCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli zk signatures-for-asset EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v --json`)
...
sendCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli send broadcast <base64-tx> --json`)
...
sendCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli send raw <base64-tx> --json`)
...
sendCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli send sender <base64-tx> --region US_EAST --json`)
...
sendCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli send poll 5UfDuX7hXbDjdMRbQMCbNvPZQEr4mEAMq3fNM7oKnUFqpEygPoAEsm2MFVwfCaG1CjprB2og8LmNVBLMrACG7L4 --json`)
...
sendCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli send compute-units <base64-tx> --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli reclaim --dry-run
  $ clawd-cli reclaim --dry-run 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli reclaim -y
  $ clawd-cli reclaim --limit 50 --batch-size 15 --region US_EAST --swqos-only --yes --json
...
wsCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli ws account 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY
  $ clawd-cli ws account 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
Examples:
  $ clawd-cli ws logs
  $ clawd-cli ws logs --mentions 86xCnPeV69n6t3DnyGvkKobf9FdN2H9oiVDdaMpo2MMY --json`)
...
wsCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli ws signature 5UfDuX7hXbDjdMRbQMCbNvPZQEr4mEAMq3fNM7oKnUFqpEygPoAEsm2MFVwfCaG1CjprB2og8LmNVBLMrACG7L4 --json`)
...
wsCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli ws program TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA --json`)
...
simdCmd
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli simd get 72
  $ clawd-cli simd get 72 --json`)
...
program
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli completions bash >> ~/.bashrc
  $ clawd-cli completions zsh --install
  $ clawd-cli completions fish > ~/.config/fish/completions/clawd-cli.fish`)
...
program
  ...
  .description("Share feedback on Clawd CLI — what worked, what was confusing, or suggestions")
  ...
  .addHelpText('after', `
Examples:
  $ clawd-cli feedback "The balance command is great but I wish it showed USD values" --feedback-tool balance --model clawd-code`)
