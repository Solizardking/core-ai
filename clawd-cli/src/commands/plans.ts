...
export function plansCommand(options: OutputOptions = {}): void {
  ...
  console.log(chalk.gray("  Sign up: clawd-cli signup [--plan <plan>] [--period monthly|yearly]"));
  console.log(chalk.gray("  Upgrade: clawd-cli upgrade --plan <plan> [--period monthly|yearly]"));
