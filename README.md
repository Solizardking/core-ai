...
| [`clawd-agents`](./clawd-agents) | Specialized perps agent: Phoenix Rise, Vulcan, Imperial WS, on-chain MM, TWAMM, Telegram | `cd clawd-agents/clawd-perps-agent && npm install && npm run build` |
